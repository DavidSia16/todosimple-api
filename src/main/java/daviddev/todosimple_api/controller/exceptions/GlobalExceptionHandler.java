...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleUncaughtException (
        Exception exception,
        WebRequest request) {
        final String errorMessage = "Unkown error ocorred";
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<Object> handleConstraintVioationException(
        ConstraintViolationException constraintViolationException,
        WebRequest request) {
        String errorMessage = constraintViolationException.getMessage();
        log.error("Failed to Validade Element", constraintViolationException, errorMessage);
    return buildErrorResponse(constraintViolationException,errorMessage, 
    ...
    public ResponseEntity<Object> handleDataBidingViolationException(
        ...
        WebRequest request) {
        log.error("Failed to find the request element", dataBidingViolationException);
        String errorMessage = dataBidingViolationException.getMessage();
        return buildErrorResponse(dataBidingViolationException, 
                                   errorMessage , 
